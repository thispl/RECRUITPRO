(function () {
	...
	// ignored /home/sharmila/frappe-bench/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
				...
				.on("click", function(e) {
					...
					if(me.grid.allow_on_grid_editing() && me.grid.is_editable()) ; else {
						if (!me.grid.is_editable()) {
							me.docfields.map(function (df) { return df.read_only = 1; });
						}
						me.toggle_view();
						return false;
					}
